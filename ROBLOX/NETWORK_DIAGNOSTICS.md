...
| `ROBLOX/LicenseVerifier.lua` | **Updated** — added `PingServer()`, ping-before-verify flow, URL/payload/status/duration logging |
| `ROBLOX/LicenseController.lua` | **Updated** — added `CANNOT_REACH_SERVER` error message, `ActiveRequests` tracking, debug logging |
